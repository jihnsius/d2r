...
static int opt_AutoReturnTime,opt_RespawnTime,opt_FlagInHome,opt_FlagIndicator,opt_BombIndicator;
...
void net_udp_send_player_flags()
{
	...
	{
		multi_send_flags(i);
		multi_send_spectator_status_to_new_player(i);		// jinx 01-31-13 spec
	}
}
