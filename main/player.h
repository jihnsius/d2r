...
#define PLAYER_STRUCT_VERSION   19  // increment this every time player struct changes
...
typedef struct player {
	...
	short		flag_returns_total;			// jinx 01-03-13 ctfc
	short		flag_captures_total;		// jinx 01-03-13 ctfc
	short		net_teamkills_total;		// jinx 01-03-13 ctfc
	short		flag_points_total;			// jinx 01-05-13 ctfc
	
	int	kwtype;					// jinx 02-04-13 weapon types
	int	kwid;					// jinx 02-05-13 weapon types
