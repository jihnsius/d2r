...
//char *http_server="http://beta.descentrangers.com/WebApi/DxxRebirth/v01/GameReport/ReportGame?AspxAutoDetectCookieSupport=1";
char *http_server="http://beta.descentrangers.com/";
/* server port number */
int  http_port=80;
